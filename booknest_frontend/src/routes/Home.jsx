...
export default function Home() {
  ...
  return (
    <main id="main-content" className="container" role="main" aria-labelledby="home-heading">
      ...
      <div style={{ display: 'flex', gap: 8, overflowX: 'auto', padding: '12px 2px' }} aria-label="Categories" role="list">
        {categories.map((c) => {
      ...
      <section style={{ marginTop: 8 }}>
        ...
        >
          {recRows.map((b) => (
            <div key={b.id} className="card" style={{ minWidth: 160, padding: 10 }} role="listitem" aria-label={`${b.title} by ${b.author}`}>
